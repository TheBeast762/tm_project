...
validation_sizes = [0.05, 0.06, 0.07, 0.08, 0.09, 0.11, 0.12, 0.13, 0.14, 0.15]
for val_size in validation_sizes:
  print("__________VAL_SIZE_{}__________".format(val_size))
  ############################################################################
  # LOAD DATA
  ############################################################################
  ...
  if FINAL:
      ...
      training, testing = loader.load_final(val_size)
  else:
  ...
  pickle.dump(history.history,
              open("val_size{}.pickle".format(val_size), "wb"))
